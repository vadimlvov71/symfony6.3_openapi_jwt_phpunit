...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.login' => ($container->privates['.security.request_matcher.lhUeM0y'] ?? $container->load('get_Security_RequestMatcher_LhUeM0yService'));
            yield 'security.firewall.map.context.api' => ($container->privates['.security.request_matcher.qLZcO0W'] ?? $container->load('get_Security_RequestMatcher_QLZcO0WService'));
        }, 3));
    }
